...
"""
    #prompt_list = ["colloquial", "friendly", "sincere", "stinky"]
    #prompt_dict = {}
    ...
    #for prompt_type in prompt_list
        ...
        prompt_dict[prompt_type] = response
    responses = prompt_dict.values()
    return responses.randomchoices(k=1).text.strip()
"""
